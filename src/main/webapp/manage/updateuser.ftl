...
<body>
	<form action="${base}/user/updateuser" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
		<table width="50%">
				<input type="hidden" value="${currentUser.userId }" type="text" name="userId">
			<tr>
				<td class="ri">手机号：</td>
				<td class="cn"><input value="${currentUser.userPhone }" type="text" name="userPhone" id="phone" onblur="checkphone(this)"></td>
				<td><span id="phone_span"></span></td>
			</tr>
			<tr>
				<td class="ri">密码：</td>
				<td class="cn"><input value="${currentUser.userPassword }" type="password" name="userPassword" id="password" onblur="checkpassword(this)"></td>
				<td><span id="password_span"></span></td>
			</tr>
			<tr>
				<td class="ri">确认密码：</td>
				<td class="cn"><input value="${currentUser.userPassword }" type="password"  id="repassword" onblur="checkrepassword(this)"></td>
				<td><span id="repassword_span"></span></td>
			</tr>
			<tr>
				<td class="ri">邮箱：</td>
				<td class="cn"><input value="${currentUser.userEmail }" type="text" name="userEmail"></td>
			</tr>
			<tr>
				<td class="ri">昵称：</td>
				<td class="cn"><input value="${currentUser.userNickname }" type="text" name="userNickname"></td>
			</tr>
			...
			<tr>
				<td class="ri">身份证：</td>
				<td><input value="${currentUser.userPid }" type="text" name="userPid"></td>
			</tr>
			<tr>
				<td class="ri">真实姓名：</td>
				<td class="cn"><input value="${currentUser.userRealname }" type="text" name="userRealname"></td>
			</tr>
			<tr>
				<td class="ri">角色：</td>
				<td class="cn"><input value="${currentUser.userRole }" type="text" name="userRole"></td>
			</tr>
			<tr>
				<td cospan="" class="ri">
