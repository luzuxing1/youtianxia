...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <img src="${base}/static/publish_house_2/countpv" width="0" height="0"><script charset="utf-8" src="${base}/static/publish_house_2/v.js.下载"></script><script type="text/javascript" async="" src="${base}/static/publish_house_2/load.min.js.下载"></script><script src="${base}/static/publish_house_2/jquery-1.6.2.min.js.下载" language="javascript" type="text/javascript"></script>
    <script src="${base}/static/publish_house_2/jQuery.cookie.js.下载" language="javascript" type="text/javascript"></script>
    <link href="${base}/static/publish_house_2/public.css" rel="stylesheet" type="text/css"> 
    ...
    <link href="${base}/static/publish_house_2/DescriptionenNew.css" rel="stylesheet" type="text/css">
    <script src="${base}/static/publish_house_2/ClientValidation.js.下载" type="text/javascript"></script>
    <script type="text/javascript">
...
<script src="${base}/static/publish_house_2/saved_resource"></script><link rel="stylesheet" type="text/css" href="${base}/static/publish_house_2/Youtx_WebIM.css"></head>
<body>
...
<script type="text/javascript" src="${base}/static/publish_house_2/Login_Cookie.js.下载"></script>
<script type="text/javascript">
    //监控代码请勿删除
...
<div id="youtxlogin" class="header" style="">
    <p class="logo">
        <a href="http://www.youtx.com/" id="youtx_01" target="_blank"><img src="${base}/static/publish_house_2/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<!--        <li class="PosRe"><a href="http://www.youtx.com/mo/" target="_blank"  rel="nofollow" id="youtx_04">手机游天下</a></li>-->
        <li><a href="http://www.youtx.com/profile/BookingTeam" target="_blank">团队订房</a><img alt="新" src="${base}/static/publish_house_2/NewIco.gif" style="display:none;left:45px;" class="PosAb TN17"></li>
        ...
        <div class="ytxMobCon" style="display:none">
            ...
            <dl>
            	<dt>扫描二维码安装游天下客户端</dt>
                <dd><a href="http://www.youtx.com/mo/" target="_blank"><img src="${base}/static/publish_house_2/youtxapp.png" width="120" height="120"></a></dd>
            </dl>
            <dl>
            	<dt><span class="ColorBlue">微信</span>扫描二维码使用游天下</dt>
                <dd><img src="${base}/static/publish_house_2/ewmBNew.jpg" width="102" height="102"></dd>
                <dd>微信公众号：游天下</dd>
            </dl>
...
<div id="youtxloginw" class="header" style="display: none;">
    <p class="logo">
        <a href="http://www.youtx.com/" target="_blank" id="youtx_01">
            <img src="${base}/static/publish_house_2/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<script type="text/javascript">
    ...
    <div class="Description">
        ...
        <div class="DescriptionContent">
            <h3><img id="daohang" src="${base}/static/publish_house_2/publishPlan502_.jpg" alt=""></h3>
...
<!--尾部2011-9-6修改 start-->
    ...
    <ul class="footer_link">
      ...
      <li class="footer_link_space">|</li>
      <li class="footer_link_grey footer_link_space" style="margin: 0;">客服热线：400-630-0088，客服邮箱：<span>service</span> <img src="${base}/static/publish_house_2/at.jpg"> <span>youtx.com</span></li>
    </ul>
    ...
    <ul class="FooterNet">
      ...
      <li><a target="_blank" href="https://trustsealinfo.verisign.com/splash?form_file=fdf%2Fsplash.fdf&amp;sap=&amp;dn=passport.youtx.com&amp;zoneoff=&amp;lang=zh_CN" rel="nofollow"><img src="${base}/static/publish_house_2/VerisignYoutx.gif" height="35" width="60"></a></li>
      <li><a href="https://www.itrust.org.cn/yz/pjwx.asp?wm=1766253730" rel="nofollow" target="_blank"><img src="${base}/static/publish_house_2/FooterNetPic.gif"></a></li>
      <li><a target="_blank" href="https://ss.knet.cn/verifyseal.dll?sn=e12032211010015160307708&amp;ct=df&amp;pa=318891" rel="nofollow"><img src="${base}/static/publish_house_2/TrustYoutx.gif" width="100" height="35px"></a></li>
    </ul>
  </div>
<!--2013-6-26修改-->
<script type="text/javascript">
...
</script><script src="${base}/static/publish_house_2/h.js.下载" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=eb4b7b326a601c545c14e8b6b965e4a0" target="_blank"><img border="0" src="${base}/static/publish_house_2/21.gif" width="20" height="20"></a>
...
<script type="text/javascript" src="${base}/static/publish_house_2/conversion.js.下载">
</script>
<noscript>
...
<script type="text/javascript" src="${base}/static/publish_house_2/rt.js.下载"></script>
<noscript>
