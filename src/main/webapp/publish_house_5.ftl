...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <img src="${base}/static/publish_house_5/countpv" width="0" height="0"><script charset="utf-8" src="${base}/static/publish_house_5/v.js.下载"></script><script type="text/javascript" async="" src="${base}/static/publish_house_5/load.min.js.下载"></script><script src="${base}/static/publish_house_5/jquery-1.6.2.min.js.下载" language="javascript" type="text/javascript"></script>
    <script src="${base}/static/publish_house_5/jQuery.cookie.js.下载" language="javascript" type="text/javascript"></script>
    <link href="${base}/static/publish_house_5/public.css" rel="stylesheet" type="text/css"> 
    ...
    <link href="${base}/static/publish_house_5/DescriptionenNew.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="${base}/static/publish_house_5/province_city.js.下载"></script>
    <script src="${base}/static/publish_house_5/popup_layer.js.下载" type="text/javascript"></script>
...
<script src="${base}/static/publish_house_5/saved_resource"></script><link rel="stylesheet" type="text/css" href="${base}/static/publish_house_5/Youtx_WebIM.css"></head>
<body>
...
<script type="text/javascript" src="${base}/static/publish_house_5/Login_Cookie.js.下载"></script>
<script type="text/javascript">
    //监控代码请勿删除
...
<div id="youtxlogin" class="header" style="">
    <p class="logo">
        <a href="http://www.youtx.com/" id="youtx_01" target="_blank"><img src="${base}/static/publish_house_5/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<!--        <li class="PosRe"><a href="http://www.youtx.com/mo/" target="_blank"  rel="nofollow" id="youtx_04">手机游天下</a></li>-->
        <li><a href="http://www.youtx.com/profile/BookingTeam" target="_blank">团队订房</a><img alt="新" src="${base}/static/publish_house_5/NewIco.gif" style="display:none;left:45px;" class="PosAb TN17"></li>
        ...
        <div class="ytxMobCon" style="display:none">
            ...
            <dl>
            	<dt>扫描二维码安装游天下客户端</dt>
                <dd><a href="http://www.youtx.com/mo/" target="_blank"><img src="${base}/static/publish_house_5/youtxapp.png" width="120" height="120"></a></dd>
            </dl>
            <dl>
            	<dt><span class="ColorBlue">微信</span>扫描二维码使用游天下</dt>
                <dd><img src="${base}/static/publish_house_5/ewmBNew.jpg" width="102" height="102"></dd>
                <dd>微信公众号：游天下</dd>
            </dl>
...
<div id="youtxloginw" class="header" style="display: none;">
    <p class="logo">
        <a href="http://www.youtx.com/" target="_blank" id="youtx_01">
            <img src="${base}/static/publish_house_5/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<script type="text/javascript">
    ...
    <div class="Description">
        ...
        <div class="DescriptionContent">
            <h3><img id="daohang" src="${base}/static/publish_house_5/publishPlan505_.jpg" alt=""></h3>
                            ...
                            <ul>
                                ...
                                <li class="li_middle">
                                    <div class="li_input UlBorder">
                                        ...
                                        <img width="88" class="pay_zhi" src="${base}/static/publish_house_5/alipay_small.gif" height="30">
                                    </div>
                                    <div class="li_bottom">
...
//                                                };                                               
                            ...
                            <ul class="mt30" style="display: none">
                                <li>
                                    ...
                                    <img class="pay_zhi" src="${base}/static/publish_house_5/cft.png" width="93" height="49">
                                </li>
                                <li class="mt10">
                                    <label class="savetxt">
                                        财付通户名</label>
                                      ...
                                      <ul id="ulForEn" class="card" style="display: none; margin-top: 30px;">
                                           <li class="li_middle">
                                                <div id="divPayPal" class="li_input UlBorder">
                                                    ...
                                                    <img width="102" height="30" class="pay_zhi" src="${base}/static/publish_house_5/u12_original.gif">
                                                </div>
...
<!--尾部2011-9-6修改 start-->
    ...
    <ul class="footer_link">
      ...
      <li class="footer_link_space">|</li>
      <li class="footer_link_grey footer_link_space" style="margin: 0;">客服热线：400-630-0088，客服邮箱：<span>service</span> <img src="${base}/static/publish_house_5/at.jpg"> <span>youtx.com</span></li>
    </ul>
    ...
    <ul class="FooterNet">
      ...
      <li><a target="_blank" href="https://trustsealinfo.verisign.com/splash?form_file=fdf%2Fsplash.fdf&amp;sap=&amp;dn=passport.youtx.com&amp;zoneoff=&amp;lang=zh_CN" rel="nofollow"><img src="${base}/static/publish_house_5/VerisignYoutx.gif" height="35" width="60"></a></li>
      <li><a href="https://www.itrust.org.cn/yz/pjwx.asp?wm=1766253730" rel="nofollow" target="_blank"><img src="${base}/static/publish_house_5/FooterNetPic.gif"></a></li>
      <li><a target="_blank" href="https://ss.knet.cn/verifyseal.dll?sn=e12032211010015160307708&amp;ct=df&amp;pa=318891" rel="nofollow"><img src="${base}/static/publish_house_5/TrustYoutx.gif" width="100" height="35px"></a></li>
    </ul>
  </div>
<!--2013-6-26修改-->
<script type="text/javascript">
...
</script><script src="${base}/static/publish_house_5/h.js.下载" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=eb4b7b326a601c545c14e8b6b965e4a0" target="_blank"><img border="0" src="${base}/static/publish_house_5/21.gif" width="20" height="20"></a>
...
<script type="text/javascript" src="${base}/static/publish_house_5/conversion.js.下载">
</script>
<noscript>
...
<script type="text/javascript" src="${base}/static/publish_house_5/rt.js.下载"></script>
<noscript>
