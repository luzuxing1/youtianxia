...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <img src="${base}/static/room_manageOrder/countpv" width="0" height="0"><script charset="utf-8" src="${base}/static/room_manageOrder/v.js.下载"></script><script type="text/javascript" async="" src="${base}/static/room_manageOrder/load.min.js.下载"></script><script src="${base}/static/room_manageOrder/jquery-1.6.2.min.js.下载" language="javascript" type="text/javascript"></script>

    <link href="${base}/static/room_manageOrder/public.css" rel="stylesheet" type="text/css">

    <script type="text/javascript" src="${base}/static/room_manageOrder/jQuery.cookie.js.下载"></script>



    <title>订单管理-游天下</title>

    <link href="${base}/static/room_manageOrder/public(1).css" rel="stylesheet" type="text/css">
    <link href="${base}/static/room_manageOrder/style.css" rel="stylesheet" type="text/css">
    <link href="${base}/static/room_manageOrder/traveling.css" rel="stylesheet" type="text/css">

    <script src="${base}/static/room_manageOrder/popup_layer_new.js.下载" type="text/javascript"></script>
    <script type="text/javascript" src="${base}/static/room_manageOrder/jquery.ui.datepicker-zh.min.js.下载"></script>
    <script src="${base}/static/room_manageOrder/jquery-ui-1.8.14.custom.min.js.下载" type="text/javascript"></script>
    <script type="text/javascript" src="${base}/static/room_manageOrder/dateFormat.js.下载"></script>



<script src="${base}/static/room_manageOrder/saved_resource"></script><link rel="stylesheet" type="text/css" href="${base}/static/room_manageOrder/Youtx_WebIM.css"></head>
<body>
    <div class="wrapper">
...
<script type="text/javascript" src="${base}/static/room_manageOrder/Login_Cookie.js.下载"></script>
<script type="text/javascript">
    //监控代码请勿删除
...
<div id="youtxlogin" class="header" style="">
    <p class="logo">
        <a href="http://www.youtx.com/" id="youtx_01" target="_blank"><img src="${base}/static/room_manageOrder/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<!--        <li class="PosRe"><a href="http://www.youtx.com/mo/" target="_blank"  rel="nofollow" id="youtx_04">手机游天下</a></li>-->
        <li><a href="http://www.youtx.com/profile/BookingTeam" target="_blank">团队订房</a><img alt="新" src="${base}/static/room_manageOrder/NewIco.gif" style="display:none;left:45px;" class="PosAb TN17"></li>
        ...
        <div class="ytxMobCon" style="display:none">
            ...
            <dl>
            	<dt>扫描二维码安装游天下客户端</dt>
                <dd><a href="http://www.youtx.com/mo/" target="_blank"><img src="${base}/static/room_manageOrder/youtxapp.png" width="120" height="120"></a></dd>
            </dl>
            <dl>
            	<dt><span class="ColorBlue">微信</span>扫描二维码使用游天下</dt>
                <dd><img src="${base}/static/room_manageOrder/ewmBNew.jpg" width="102" height="102"></dd>
                <dd>微信公众号：游天下</dd>
            </dl>
...
<div id="youtxloginw" class="header" style="display: none;">
    <p class="logo">
        <a href="http://www.youtx.com/" target="_blank" id="youtx_01">
            <img src="${base}/static/room_manageOrder/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<p class="warnning_info">亲爱的房东您好，游天下短租网提醒您，为谨防网络诈骗，请勿要相信除平台规定外的下单及支付方式，如有疑问，请致电：4006300088！</p>
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            ...
            var recentCount = "0";
            var historyCount = "0";
            var conditionCount =${countAllOrder};
...
<!--尾部2011-9-6修改 start-->
    ...
    <ul class="footer_link">
      ...
      <li class="footer_link_space">|</li>
      <li class="footer_link_grey footer_link_space" style="margin: 0;">客服热线：400-630-0088，客服邮箱：<span>service</span> <img src="${base}/static/room_manageOrder/at.jpg"> <span>youtx.com</span></li>
    </ul>
    ...
    <ul class="FooterNet">
      ...
      <li><a target="_blank" href="https://trustsealinfo.verisign.com/splash?form_file=fdf%2Fsplash.fdf&amp;sap=&amp;dn=passport.youtx.com&amp;zoneoff=&amp;lang=zh_CN" rel="nofollow"><img src="${base}/static/room_manageOrder/VerisignYoutx.gif" height="35" width="60"></a></li>
      <li><a href="https://www.itrust.org.cn/yz/pjwx.asp?wm=1766253730" rel="nofollow" target="_blank"><img src="${base}/static/room_manageOrder/FooterNetPic.gif"></a></li>
      <li><a target="_blank" href="https://ss.knet.cn/verifyseal.dll?sn=e12032211010015160307708&amp;ct=df&amp;pa=318891" rel="nofollow"><img src="${base}/static/room_manageOrder/TrustYoutx.gif" width="100" height="35px"></a></li>
    </ul>
  </div>
<!--2013-6-26修改-->
<script type="text/javascript">
...
</script><script src="${base}/static/room_manageOrder/h.js.下载" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=eb4b7b326a601c545c14e8b6b965e4a0" target="_blank"><img border="0" src="${base}/static/room_manageOrder/21.gif" width="20" height="20"></a>
...
<script type="text/javascript" src="${base}/static/room_manageOrder/conversion.js.下载">
</script>
<noscript>
...
<script type="text/javascript" src="${base}/static/room_manageOrder/rt.js.下载"></script>
<noscript>
