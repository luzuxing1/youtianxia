...
<ul class="NewSubNav">
 ...
 <ul class="mycenter_smalltitle mycenter_smalltitle2">
                  <li class=""><a href="">订单管理</a></li>
                    <li class="active"><a href="${base}/landlordOrder/jumpRoomMaster">房源管理</a></li>
                     <li class="" style="position:relative;z-index:10"><a href="">排期管理</a></li>
                       
                    <li class="" style="position: relative; z-index: 10"><a href="">我的竞争力<img style="position: absolute; top: -11px; right: -14px;" src="${base}/static/room_master_manageRoom/new.gif" alt="新"></a></li>
                      
                    <li class=""><a href="">赚到的钱</a></li>
                     
                     <li class="" style="position: relative; z-index: 10"><a href="">促销推广
