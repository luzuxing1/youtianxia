...
<#assign base=request.contextPath />
    ...
    <img src="${base}/static/room_master_manageRoom/countpv" width="0" height="0"><script charset="utf-8" src="${base}/static/room_master_manageRoom/v.js.下载"></script><script type="text/javascript" async="" src="${base}/static/room_master_manageRoom/load.min.js.下载"></script><script src="${base}/static/room_master_manageRoom/jquery-1.6.2.min.js.下载" language="javascript" type="text/javascript"></script>
    <script src="${base}/static/room_master_manageRoom/jQuery.cookie.js.下载" language="javascript" type="text/javascript"></script>
    <link href="${base}/static/room_master_manageRoom/public.css" rel="stylesheet" type="text/css"> 
    
    
    
    <title>
        游天下-我的账户-我的房间-房间列表</title>
    <script language="javascript" type="text/javascript" src="${base}/static/room_master_manageRoom/jquery-1.6.2.min.js(1).下载"></script>
    <link href="${base}/static/room_master_manageRoom/rooms.css" rel="stylesheet" type="text/css">
    
    <script type="text/javascript" src="${base}/static/room_master_manageRoom/jQuery.cookie.js(1).下载"></script>
...
<script src="${base}/static/room_master_manageRoom/saved_resource"></script><link rel="stylesheet" type="text/css" href="${base}/static/room_master_manageRoom/Youtx_WebIM.css"></head>
<body>
...
<script type="text/javascript" src="${base}/static/room_master_manageRoom/Login_Cookie.js.下载"></script>
<script type="text/javascript">
    //监控代码请勿删除
...
<div id="youtxlogin" class="header" style="">
    <p class="logo">
        <a href="http://www.youtx.com/" id="youtx_01" target="_blank"><img src="${base}/static/room_master_manageRoom/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<!--        <li class="PosRe"><a href="http://www.youtx.com/mo/" target="_blank"  rel="nofollow" id="youtx_04">手机游天下</a></li>-->
        <li><a href="http://www.youtx.com/profile/BookingTeam" target="_blank">团队订房</a><img alt="新" src="${base}/static/room_master_manageRoom/NewIco.gif" style="display:none;left:45px;" class="PosAb TN17"></li>
        ...
        <div class="ytxMobCon" style="display:none">
            ...
            <dl>
            	<dt>扫描二维码安装游天下客户端</dt>
                <dd><a href="http://www.youtx.com/mo/" target="_blank"><img src="${base}/static/room_master_manageRoom/youtxapp.png" width="120" height="120"></a></dd>
            </dl>
            <dl>
            	<dt><span class="ColorBlue">微信</span>扫描二维码使用游天下</dt>
                <dd><img src="${base}/static/room_master_manageRoom/ewmBNew.jpg" width="102" height="102"></dd>
                <dd>微信公众号：游天下</dd>
            </dl>
...
<div id="youtxloginw" class="header" style="display: none;">
    <p class="logo">
        <a href="http://www.youtx.com/" target="_blank" id="youtx_01">
            <img src="${base}/static/room_master_manageRoom/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<ul class="NewSubNav">
 ...
 <ul class="mycenter_smalltitle mycenter_smalltitle2">
                  <li class=""><a href="http://www.youtx.com/payment/User/MyroomEn/OrderManageEn.aspx">订单管理</a></li>
                    ...
                    <li class="" style="position: relative; z-index: 10"><a href="http://www.youtx.com/houseRank/">我的竞争力<img style="position: absolute; top: -11px; right: -14px;" src="${base}/static/room_master_manageRoom/new.gif" alt="新"></a></li>
...
<div class="AreaOrder_Ad" style="margin: 10px auto 0; width: 945px;"><a href="http://www.youtx.com/zhuanti/2017mxfdshy/index.html" target="_blank"><img src="${base}/static/room_master_manageRoom/2017mxfd.jpg" width="945" height="55" border="0" alt=""></a></div>
                        ...
                        <li class="clearfix" style="margin-top: 0pt; padding-top: 0pt; border-top: none;">
                                ...
                                <div class="mc_m_c_alone_img">
                                        ...
                                        <div class="mc_m_c_alone_img_word">
                                            <img src="${base}/static/room_master_manageRoom/shenhezhong.png">
...
<!--尾部2011-9-6修改 start-->
    ...
    <ul class="footer_link">
      ...
      <li class="footer_link_space">|</li>
      <li class="footer_link_grey footer_link_space" style="margin: 0;">客服热线：400-630-0088，客服邮箱：<span>service</span> <img src="${base}/static/room_master_manageRoom/at.jpg"> <span>youtx.com</span></li>
    </ul>
    ...
    <ul class="FooterNet">
      ...
      <li><a target="_blank" href="https://trustsealinfo.verisign.com/splash?form_file=fdf%2Fsplash.fdf&amp;sap=&amp;dn=passport.youtx.com&amp;zoneoff=&amp;lang=zh_CN" rel="nofollow"><img src="${base}/static/room_master_manageRoom/VerisignYoutx.gif" height="35" width="60"></a></li>
      <li><a href="https://www.itrust.org.cn/yz/pjwx.asp?wm=1766253730" rel="nofollow" target="_blank"><img src="${base}/static/room_master_manageRoom/FooterNetPic.gif"></a></li>
      <li><a target="_blank" href="https://ss.knet.cn/verifyseal.dll?sn=e12032211010015160307708&amp;ct=df&amp;pa=318891" rel="nofollow"><img src="${base}/static/room_master_manageRoom/TrustYoutx.gif" width="100" height="35px"></a></li>
    </ul>
  </div>
<!--2013-6-26修改-->
<script type="text/javascript">
...
</script><script src="${base}/static/room_master_manageRoom/h.js.下载" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=eb4b7b326a601c545c14e8b6b965e4a0" target="_blank"><img border="0" src="${base}/static/room_master_manageRoom/21.gif" width="20" height="20"></a>
...
<script type="text/javascript" src="${base}/static/room_master_manageRoom/conversion.js.下载">
</script>
<noscript>
...
<script type="text/javascript" src="${base}/static/room_master_manageRoom/rt.js.下载"></script>
<noscript>
